...
Logo"
                ...
                <span class="brand-text font-weight-light">Presensi LabKom</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
 ...
 with font-awesome or any other icon font library -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start">
                                                        <div class="p-2">
                                                            <a href="{{ url('/editmahasiswa/'.$item->id)}}" class="btn btn-sm btn-warning">Edit</a>
                                                        </div>
                                                        <div class="p-2">
                                                            <form action="{{ url('/mahasiswadelete/'.$item->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                Lab. Fakultas Ilmu Komputer - UNIKU
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="https://uniku.ac.id">uniku.ac.id</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
    <!-- REQUIRED SCRIPTS -->
